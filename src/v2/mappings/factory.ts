...
export function handleNewPair(event: PairCreated): void {
  ...
  if (factory === null) {
    ...
    factory.pairCount = 0
    factory.totalVolumeNativeToken = ZERO_BD
    factory.totalLiquidityNativeToken = ZERO_BD
  ...
  if (token0 === null) {
    ...
    token0.derivedNativeToken = ZERO_BD
  ...
  if (token1 === null) {
    ...
    token1.derivedNativeToken = ZERO_BD
  ...
  pair.trackedReserveNativeToken = ZERO_BD
  pair.reserveNativeToken = ZERO_BD
